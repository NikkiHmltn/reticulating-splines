  ...
  return (
    <div>
      ...
      <nav>
        ...
        {/* <!-- Dropdown Trigger --> */}
        <li><a className="dropdown-trigger" href="#!" data-target="gen-drop">Generators<i className="material-icons right">arrow_drop_down</i></a></li>
        <li>                    
    ...
    <li>
        ...
        <li>
          {/* <!-- Dropdown Trigger --> */}
        <a className='dropdown-trigger' href='#' data-target='gen-drop'>Generators</a>
        </li>
        <li>                    
          <NavLink to="/donate" className={({isActive}) => (isActive ? "active-navlink" : "navlink")}>Donate</NavLink>
        </li>
